      ...
      <div className="antialiased bg-gray-50 dark:bg-gray-900">
        <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
          <div className="flex flex-wrap justify-between items-center">
            ...
            {!isConnected && (
              <div className="text-red-500">Database is NOT connected</div>
            )}
          </div>
        </nav>
              ...
              {loading ? (
                ...
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                  <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                      <th scope="col" className="px-6 py-3">Tên cây</th>
                      <th scope="col" className="px-6 py-3">Loài</th>
                      <th scope="col" className="px-6 py-3">Vị trí</th>
                      <th scope="col" className="px-6 py-3">Ngày trồng</th>
                      <th scope="col" className="px-6 py-3">Giai đoạn phát triển</th>
                      <th scope="col" className="px-6 py-3"><span className="sr-only">Xem</span></th>
                    </tr>
                  </thead>
                  <tbody>
                    {trees.length === 0 ? (
                      ...
                      trees.map((tree) => (
                        <tr key={tree._id.toString()} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                          <th
                            scope="row"
